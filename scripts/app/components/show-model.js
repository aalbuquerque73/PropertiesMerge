...
define(['knockout', 'underscore', 'utils'],
function(ko, _, U) {
    'use strict';
    ...
    function ViewModel(params) {
        ...
        console.log('[show:ViewModel]', params.value, options, events);
        
        if (params.value.subscribe) {
            var model = this;
            ...
            params.value.dispose = function() {
                console.log('[show:ViewModel:dispose]', arguments);
        ...
        this.onclick = function() {console.log('[show:ViewModel] default onclick');};
        _.each(events, function(callback, event) {
            if (typeof this[event] === 'function') {
                console.log('[show:ViewModel:events] setup', event, callback);
                this[event] = callback;
            }
        }, this);
    }
    ...
    return {
        viewModel: ViewModel,
        template: { require: 'text!templates/static-list-item.html' }
    };
});